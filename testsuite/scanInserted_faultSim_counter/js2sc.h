...
SC_MODULE( counter_m ) {
    ...
    sc_signal<sc_logic, SC_MANY_WRITERS> So_sig;
...
SC_HAS_PROCESS(counter_m);
    ...
    pin_31 = new pin_flt("pin_31", accessRegistry);
        pin_31->in1(global_reset);
        pin_31->out1(global_reset_sig);
    
    pin_32 = new pin_flt("pin_32", accessRegistry);
        pin_32->in1(NbarT);
        pin_32->out1(NbarT_sig);
    
    pin_33 = new pin_flt("pin_33", accessRegistry);
        pin_33->in1(Si);
        pin_33->out1(Si_sig);
    
    pout_34 = new pout_flt("pout_34", accessRegistry);
        pout_34->in1(So_sig);
        pout_34->out1(So);
