...
SC_HAS_PROCESS(counter_m);
    ...
    notg_0 = new notg("notg_0", accessRegistry);
        notg_0->in1(new_counter_reg_0);
        notg_0->out1(S4);

    notg_1 = new notg("notg_1", accessRegistry);
        notg_1->in1(new_counter_reg_3);
        notg_1->out1(S5);

    notg_2 = new notg("notg_2", accessRegistry);
        notg_2->in1(S20);
        notg_2->out1(S6);

    nand_n_3 = new nand_n("nand_n_3", accessRegistry);
        nand_n_3->in1[0](new_counter_reg_1);
        nand_n_3->in1[1](new_counter_reg_0);
        nand_n_3->out1(S7);

    nand_n_4 = new nand_n("nand_n_4", accessRegistry);
        nand_n_4->in1[0](new_counter_reg_2);
        nand_n_4->in1[1](new_counter_reg_3);
        nand_n_4->out1(S8);

    nor_n_5 = new nor_n("nor_n_5", accessRegistry);
        nor_n_5->in1[0](S8);
        nor_n_5->in1[1](S7);
        nor_n_5->out1(S19);

    nor_n_6 = new nor_n("nor_n_6", accessRegistry);
        nor_n_6->in1[0](S6);
        nor_n_6->in1[1](S4);
        nor_n_6->out1(S9);

    nor_n_7 = new nor_n("nor_n_7", accessRegistry);
        nor_n_7->in1[0](S20);
        nor_n_7->in1[1](new_counter_reg_0);
        nor_n_7->out1(S10);

    nor_n_8 = new nor_n("nor_n_8", accessRegistry);
        nor_n_8->in1[0](S10);
        nor_n_8->in1[1](S9);
        nor_n_8->out1(S0);

    nor_n_9 = new nor_n("nor_n_9", accessRegistry);
        nor_n_9->in1[0](S7);
        nor_n_9->in1[1](S6);
        nor_n_9->out1(S11);

    nor_n_10 = new nor_n("nor_n_10", accessRegistry);
        nor_n_10->in1[0](S9);
        nor_n_10->in1[1](new_counter_reg_1);
        nor_n_10->out1(S12);

    nor_n_11 = new nor_n("nor_n_11", accessRegistry);
        nor_n_11->in1[0](S12);
        nor_n_11->in1[1](S11);
        nor_n_11->out1(S1);

    nand_n_12 = new nand_n("nand_n_12", accessRegistry);
        nand_n_12->in1[0](S11);
        nand_n_12->in1[1](new_counter_reg_2);
        nand_n_12->out1(S13);

    notg_13 = new notg("notg_13", accessRegistry);
        notg_13->in1(S13);
        notg_13->out1(S14);

    nor_n_14 = new nor_n("nor_n_14", accessRegistry);
        nor_n_14->in1[0](S11);
        nor_n_14->in1[1](new_counter_reg_2);
        nor_n_14->out1(S15);

    nor_n_15 = new nor_n("nor_n_15", accessRegistry);
        nor_n_15->in1[0](S15);
        nor_n_15->in1[1](S14);
        nor_n_15->out1(S2);

    nor_n_16 = new nor_n("nor_n_16", accessRegistry);
        nor_n_16->in1[0](S14);
        nor_n_16->in1[1](new_counter_reg_3);
        nor_n_16->out1(S16);

    nor_n_17 = new nor_n("nor_n_17", accessRegistry);
        nor_n_17->in1[0](S13);
        nor_n_17->in1[1](S5);
        nor_n_17->out1(S17);

    nor_n_18 = new nor_n("nor_n_18", accessRegistry);
        nor_n_18->in1[0](S17);
        nor_n_18->in1[1](S16);
        nor_n_18->out1(S3);

    dff_19 = new dff("dff_19", accessRegistry);
        dff_19->C(S18);
    ...
    dff_20 = new dff("dff_20", accessRegistry);
        dff_20->C(S18);
    ...
    dff_21 = new dff("dff_21", accessRegistry);
        dff_21->C(S18);
    ...
    dff_22 = new dff("dff_22", accessRegistry);
        dff_22->C(S18);
    ...
    pin_23 = new pin("pin_23", accessRegistry);
        pin_23->in1(clk);
        pin_23->out1(S18);

    pout_24 = new pout("pout_24", accessRegistry);
        pout_24->in1(S19);
        pout_24->out1(co);

    pout_25 = new pout("pout_25", accessRegistry);
        pout_25->in1(new_counter_reg_0);
        pout_25->out1(counter[0]);

    pout_26 = new pout("pout_26", accessRegistry);
        pout_26->in1(new_counter_reg_1);
        pout_26->out1(counter[1]);

    pout_27 = new pout("pout_27", accessRegistry);
        pout_27->in1(new_counter_reg_2);
        pout_27->out1(counter[2]);

    pout_28 = new pout("pout_28", accessRegistry);
        pout_28->in1(new_counter_reg_3);
        pout_28->out1(counter[3]);

    pin_29 = new pin("pin_29", accessRegistry);
        pin_29->in1(en);
        pin_29->out1(S20);

    pin_30 = new pin("pin_30", accessRegistry);
        pin_30->in1(rst);
        pin_30->out1(S21);
